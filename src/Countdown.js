export const Countdown = ({ seconds, timerStatus, stopBloom, setTimerStatus, pour1Amount }) => (
  <div className="bg-gradient-to-br from-pink-600 p-1 to-blue-400 rounded-full ">
    {timerStatus === "STARTED" ? (
      ...
      >
        <span className=' absolute block pb-3 text-base   relative top-5 text-center text-white'>Pour {pour1Amount * 2}g Water... </span>
        {seconds}
      </button>
            </div>
    ) : (
